...
class TestAmenity(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.amenity = Amenity(name="First Amenity")
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(
            self.amenity.created_at.isoformat(), amenity_dict["created_at"]
        )
        self.assertEqual(
            self.amenity.updated_at.isoformat(), amenity_dict["updated_at"]
        )
